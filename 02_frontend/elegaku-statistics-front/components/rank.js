...
const Rank = (props) => {
  console.log(props.attendancesMonth);

  const attendanceDays = props.attendancesMonth.sort((a, b) => (a.attendanceDays < b.attendanceDays ? 1 : -1));
  const attendanceTime = props.attendancesMonth.sort((a, b) => (a.attendanceTime < b.attendanceTime ? 1 : -1));
